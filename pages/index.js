        ...
        <div id='cardStuff'>
          ...
          <div id='projectStuff'>
            <div className={styles.grid}>
              <a href="https://beckyboo88.github.io/The-Colorado-Trail/" target='_blank' rel='noreferrer' className={styles.card}>
                <h1>The Colorado Trail &rarr;</h1>
                <p>Interactive game similar to Oregon Trail.  Uses: HTML, CSS, and JavaScript</p>
              </a>

              <a href="https://find-your-national-park.herokuapp.com" target='_blank' rel='noreferrer' className={styles.card2}>
                <h1>Find Your Trail &rarr;</h1>
                <p>Web App that helps you find national parks in your state. Uses: Sequelize, Express, and EJS</p>
              </a>

              <a
                href="https://determined-nightingale-c0072d.netlify.app" target='_blank' rel='noreferrer' className={styles.card3}>
                <h1>Viberant &rarr;</h1>
              ...
              <a
                href="https://github.com/BeckyBoo88/Project-4" target='_blank' rel='noreferrer' className={styles.card4}>
